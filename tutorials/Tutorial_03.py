...
if __name__ == '__main__':
    ...
    outdir = 'qm9_ev_A_T03'
    outname = 'qm9_ev_A_T03_' + mod.network_name

    from mindspore.train.serialization import load_checkpoint,load_param_into_net
    param_file = outdir + '/' + outname + '-1_32.ckpt'
    ...
    record_cb = TrainMonitor(model, outname, per_step=1, avg_steps=32, directory=outdir, eval_dataset=ds_valid, best_ckpt_metrics=eval_loss)
