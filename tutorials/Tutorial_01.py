...
if __name__ == '__main__':
    ...
    train_file = 'ds_qm9_kJ-mol_nm_train_1024.npz'
    ...
    scale = train_data['mol_std'][idx]
    shift = train_data['mol_avg'][idx]
    ...
    net = Cybertron(mod,max_atoms_number=num_atom,full_connect=True,readout=readout,unit_dis='nm')
